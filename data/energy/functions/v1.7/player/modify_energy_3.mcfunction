...
execute store result score #player.storage energy.data run data get storage energy:temp list[0].components."minecraft:custom_data".energy.storage
execute store result score #player.max_storage energy.data run data get storage energy:temp list[0].components."minecraft:custom_data".energy.max_storage
...
# store result
execute unless score #player.delta energy.data matches 0 store result storage energy:temp list[0].components."minecraft:custom_data".energy.storage int 1 run scoreboard players get #player.storage energy.data
...
# update item
execute unless score #player.delta energy.data matches 0 run function energy:v1.7/player/modify_energy_update
