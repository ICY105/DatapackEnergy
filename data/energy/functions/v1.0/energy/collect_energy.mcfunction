...
execute as @e[type=#energy:valid_block_entities,tag=energy.send,predicate=energy:v1.0/has_network_id,scores={energy.storage=1..}] run function energy:v1.0/energy/collect_energy_2
